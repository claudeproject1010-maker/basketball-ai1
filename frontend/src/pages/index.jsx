...
export default function App() {
  ...
  return (
    <div style={{minHeight:"100vh",background:"linear-gradient(145deg,#04091a 0%,#071120 50%,#04091a 100%)",
      ...
      <div style={{position:"fixed",top:-180,left:-180,width:500,height:500,borderRadius:"50%",
        background:"rgba(59,130,246,0.18)",filter:"blur(100px)",pointerEvents:"none",zIndex:0}}/>
      ...
      {/* Main content */}
      <div className="bai-main" style={{flex:1,minWidth:0,padding:"26px 26px 60px",overflowY:"auto",position:"relative",zIndex:1}}>
        ...
        {activeTab==="predictions"&&(
          <>
            ...
            {/* KPI row */}
            <div className="bai-kpi" style={{display:"grid",gridTemplateColumns:"repeat(5,1fr)",gap:8,marginBottom:20}}>
              {[
            ...
            {/* Controls */}
            <div className="bai-ctrl" style={{display:"flex",gap:10,marginBottom:12,flexWrap:"wrap",alignItems:"center"}}>
